...
まずは [src/main.tsx](https://github.com/koralle/geek-project-pokemon-app/blob/main/src/main.tsx) を開き、以下のようにコードを編集します。
...
<img src="./images/chapter_04/363_tamazarashi_after.webp" alt="タイプごとのカラーを設定した後のダイアログ。" width="600" />
